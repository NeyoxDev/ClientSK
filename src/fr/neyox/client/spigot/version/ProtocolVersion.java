...
public class ProtocolVersion {
    ...
    static {
        ...
        // After netty rewrite
        register(v1_7_1 = new ProtocolVersion(4, "1.7"));
        register(v1_7_6 = new ProtocolVersion(5, "1.7.10"));
        register(v1_8 = new ProtocolVersion(47, "1.8"));
        ...
        register(v1_9_3 = new ProtocolVersion(110, "1.9.4"));
